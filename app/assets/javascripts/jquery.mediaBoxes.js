...
(function( window, $, undefined ){
     ...
     * ====================================================================== */
        ...
        function loadMore( boxesToLoad, ignoreFilter){
            if( loadMoreButton.hasClass('media-boxes-load-more') == false && ignoreFilter==false ){ /* Only if it is the "load more" button, no the "loading..." nor the "no more entries" button */
                //return;
            }
